  ...
  return (
    <button
      ...
      className={`rounded-2xl border px-4 py-3 text-sm font-black ${
        active ? activeClass : "border-[#f7d7a2]/15 bg-black/25 text-[#f7d7a2]/70"
      }`}
    >
      {children}
    </button>
...
function Avatar({ member, large = false }) {
  ...
  return (
    <div
      className={`flex items-center justify-center rounded-full border text-2xl ${genderClass} ${
        large ? "h-20 w-20 text-4xl" : "h-14 w-14"
      }`}
    >
      {member.avatar}
    </div>
...
function Stat({ label, value }) {
  return (
    <div className="rounded-2xl bg-white/[0.04] p-3">
      <p className="text-xs text-[#e6c9aa]/60">{label}</p>
...
function FooterLinks() {
  return (
    <div className="mt-8 flex justify-center gap-4 text-xs text-[#e6c9aa]/50">
      <a href="/privacy" className="underline hover:text-[#e6c9aa]/80">プライバシー</a>
    ...
    <AppShell>
      <section className="flex-1 rounded-[2.2rem] border border-[#f7d7a2]/20 bg-[#12080d]/80 p-5 shadow-[0_0_70px_rgba(244,63,94,.22)] backdrop-blur-xl">
        <div className="mb-5 flex items-center justify-between">
          <a href="/" className="rounded-full border border-[#f7d7a2]/15 px-3 py-2 text-xs text-[#f7d7a2]">← Top</a>
          <h1 className="font-serif text-2xl font-bold text-[#ffe8b7]">プライバシーポリシー</h1>
          <div className="w-12" />
        </div>
        <div className="text-sm leading-7 text-[#e6c9aa]/75 space-y-4">
          <p>Mutual Match（以下「本サービス」）は、以下の情報を取り扱います。</p>
          <p><strong className="text-[#ffe8b7]">収集する情報：</strong>部屋名、表示名（ニックネーム）、性別、座席番号、投票情報をサーバーに保存します。メールアドレスやパスワード等の個人認証情報は収集しません。</p>
          <p><strong className="text-[#ffe8b7]">投票情報の取り扱い：</strong>投票情報は両想い判定にのみ使用されます。片想いの相手名は原則として他の参加者に公開されません。両想いが成立した場合のみ、当事者双方の名前が結果画面に表示されます。</p>
          <p><strong className="text-[#ffe8b7]">データの保持：</strong>部屋データは作成から24時間後に削除される設計を想定しています。幹事は手動で部屋を削除することもできます。</p>
          <p><strong className="text-[#ffe8b7]">Cookie・広告：</strong>将来的に広告サービス（Google AdSense等）を導入する場合、Cookieやトラッキング技術が使用される可能性があります。導入時にはこのページを更新します。</p>
          <p><strong className="text-[#ffe8b7]">お問い合わせ：</strong>データの削除依頼やご質問は、お問い合わせページからご連絡ください。</p>
        </div>
        <FooterLinks />
      </section>
    </AppShell>
  ...
  return (
    <AppShell>
      <section className="flex-1 rounded-[2.2rem] border border-[#f7d7a2]/20 bg-[#12080d]/80 p-5 shadow-[0_0_70px_rgba(244,63,94,.22)] backdrop-blur-xl">
        <div className="mb-5 flex items-center justify-between">
          <a href="/" className="rounded-full border border-[#f7d7a2]/15 px-3 py-2 text-xs text-[#f7d7a2]">← Top</a>
          <h1 className="font-serif text-2xl font-bold text-[#ffe8b7]">利用規約</h1>
          <div className="w-12" />
        </div>
        <div className="text-sm leading-7 text-[#e6c9aa]/75 space-y-4">
          <p>本サービスをご利用いただくにあたり、以下の行為を禁止します。</p>
          <p><strong className="text-[#ffe8b7]">禁止事項：</strong></p>
          <p>・他人になりすまして投票する行為</p>
          <p>・嫌がらせや迷惑行為を目的とした利用</p>
          <p>・本サービスの運営を妨害する行為</p>
          <p>・虚偽の情報を登録する行為</p>
          <p>・その他、法令に違反する行為や公序良俗に反する行為</p>
          <p><strong className="text-[#ffe8b7]">免責事項：</strong>本サービスは現状有姿で提供されます。サービスの中断、データの損失等について、運営者は一切の責任を負いません。</p>
          <p><strong className="text-[#ffe8b7]">規約の変更：</strong>本規約は予告なく変更される場合があります。変更後の利用をもって同意したものとみなします。</p>
        </div>
        <FooterLinks />
      </section>
    </AppShell>
  ...
  return (
    <AppShell>
      <section className="flex-1 rounded-[2.2rem] border border-[#f7d7a2]/20 bg-[#12080d]/80 p-5 shadow-[0_0_70px_rgba(244,63,94,.22)] backdrop-blur-xl">
        <div className="mb-5 flex items-center justify-between">
          <a href="/" className="rounded-full border border-[#f7d7a2]/15 px-3 py-2 text-xs text-[#f7d7a2]">← Top</a>
          <h1 className="font-serif text-2xl font-bold text-[#ffe8b7]">お問い合わせ</h1>
          <div className="w-12" />
        </div>
        <div className="text-sm leading-7 text-[#e6c9aa]/75 space-y-4">
          <p>Mutual Match に関するお問い合わせは、以下のメールアドレスまでご連絡ください。</p>
          <p className="text-center">
            <a href="mailto:support@mutualmatch.app" className="text-[#ffe8b7] underline">support@mutualmatch.app</a>
          </p>
          <p><strong className="text-[#ffe8b7]">受け付ける内容：</strong></p>
          <p>・部屋データの削除依頼</p>
          <p>・不具合の報告</p>
          <p>・その他、本サービスに関するご質問</p>
          <p className="text-xs text-[#e6c9aa]/50">※ 返信にはお時間をいただく場合があります。</p>
        </div>
        <FooterLinks />
      </section>
    </AppShell>
...
function MainApp() {
  ...
  const roomUrl = `${window.location.origin}/r/${roomCode}`;
  ...
  async function reloadRoom(room = dbRoom) {
    ...
    try {
      const round = room.current_round || roundNumber;
      const dbMembers = await getMembers(room.id);
      const dbVotes = await getVotes(room.id, round);
  ...
  useEffect(() => {
    ...
    try {
      channel = supabase
        .channel(`room-${dbRoom.id}`)
        .on(
          "postgres_changes",
          { event: "*", schema: "public", table: "members", filter: `room_id=eq.${dbRoom.id}` },
          () => reloadRoom(dbRoom)
        )
        .on(
          "postgres_changes",
          { event: "*", schema: "public", table: "votes", filter: `room_id=eq.${dbRoom.id}` },
          () => reloadRoom(dbRoom)
        )
        .on(
          "postgres_changes",
          { event: "*", schema: "public", table: "rooms", filter: `id=eq.${dbRoom.id}` },
          async (payload) => {
            ...
            if (payload.new) {
              ...
              reloadRoom(updatedRoom);
            }
          }
        )
        .subscribe();
    } catch (e) {
      // Realtime may not be enabled — silently ignore
      console.warn("Realtime subscription failed (may not be enabled):", e);
    }
  ...
  useEffect(() => {
    ...
    async function loadRoomFromUrl() {
      ...
      try {
        ...
        setTargetMode(room.target_mode || "opposite");
        setPhase(room.phase);
  ...
  async function startNextRound() {
    ...
    if (dbRoom) {
      try {
        const updatedRoom = await updateRoomPhaseAndRound(dbRoom.id, "voting", nextRound);
        setDbRoom(updatedRoom);
      } catch (error) {
        console.error(error);
  ...
  async function deleteCurrentRoom() {
    ...
    if (!progressUnlocked) {
      alert("誤操作防止ロックを解除してから削除してください。");
      return;
    }

    const ok = window.confirm(
      "この部屋を削除しますか？\nメンバーと投票データもすべて削除されます。この操作は取り消せません。"
    );
    if (!ok) return;

    try {
      await deleteRoomFromDb(dbRoom.id);
      resetAll();
    } catch (error) {
      console.error(error);
      alert("部屋の削除に失敗しました。");
  ...
  function toggleVote(targetId) {
    ...
    setVotes((prev) => {
      ...
      if (current.includes(targetId)) {
        return {
          ...prev,
          [currentMember.id]: current.filter((id) => id !== targetId),
        };
      }
      ...
      if (current.length < maxSelectable) {
        return {
          ...prev,
          [currentMember.id]: [...current, targetId],
        };
      }

      return {
        ...prev,
        [currentMember.id]: [...current.slice(1), targetId],
      };
    });
  }
  ...
  function PhaseBadge() {
    ...
    return (
      <span className="rounded-full bg-rose-500/25 px-3 py-1 text-xs font-black text-rose-50">
        {label}
      </span>
    );
  }
  ...
  function SeatMap({ compact = false, creator = false }) {
    return (
      <div
        className={`relative overflow-hidden rounded-[2rem] border border-[#f7d7a2]/15 bg-[radial-gradient(circle_at_center,rgba(127,29,29,.55),rgba(8,4,9,.98)_62%)] ${
          compact ? "h-[250px]" : "h-[340px]"
        }`}
      >
        <div
          className={`absolute left-1/2 top-1/2 flex -translate-x-1/2 -translate-y-1/2 items-center justify-center border border-[#f7d7a2]/20 bg-gradient-to-br from-[#5d1022] to-[#1b090e] ${
            tableShape === "round"
              ? compact
                ? "h-28 w-28 rounded-full"
                : "h-40 w-40 rounded-full"
              : compact
                ? "h-20 w-[68%] rounded-[1.5rem]"
                : "h-28 w-[72%] rounded-[2rem]"
          }`}
        >
          <div className="text-center">
            <p className={compact ? "text-xl" : "text-2xl"}>🕯️🌹🕯️</p>
            <p className="mt-1 text-xs text-[#f7d7a2]/75">
              {tableShape === "round" ? "円卓" : "長方形"}
            </p>
          </div>
        </div>
        ...
        {seats.map((seat, index) => {
          ...
          return (
            <button
              ...
              className={`absolute rounded-full border text-center shadow-xl active:scale-95 ${seatClass(
                seat.member,
                active,
                compact
              )}`}
            >
              ...
              <span className="block truncate px-1 text-xs font-black">
                {seat.member ? seat.member.name : "空席"}
              </span>
              {seat.member?.gender && (
                <span className="block text-[10px]">
                  {seat.member.gender === "女性" ? "♀" : "♂"}
                </span>
              )}
            </button>
          );
  ...
  /* --- voting setting description for vote screen --- */
  function VoteSettingBanner() {
    const targetLabel = targetMode === "opposite" ? "異性のみ" : "全員";
    ...
    return (
      <Panel>
        <p className="text-sm text-[#e6c9aa]/75">
          この部屋は <strong className="text-[#ffe8b7]">{targetLabel}</strong> に投票できます。
          <strong className="text-[#ffe8b7]">{countLabel}</strong>。
        </p>
      </Panel>
    );
  }
        ...
        <section className="flex flex-1 flex-col justify-between rounded-[2.2rem] border border-[#f7d7a2]/20 bg-[#12080d]/80 p-5 shadow-[0_0_70px_rgba(244,63,94,.22)] backdrop-blur-xl">
          ...
          <div className="grid gap-3">
            <button
              ...
              className="rounded-2xl bg-gradient-to-r from-rose-500 via-pink-500 to-[#f7d7a2] px-5 py-4 text-sm font-black text-white"
            >
              ♡ 新しい部屋を作成する
            </button>
            <button
              type="button"
              onClick={openDemo}
              className="rounded-2xl border border-[#f7d7a2]/25 bg-black/30 px-5 py-4 text-sm font-black text-[#ffe8b7]"
            >
              デモ部屋を見る
            </button>
          </div>
        ...
        <section className="flex-1 rounded-[2.2rem] border border-[#f7d7a2]/20 bg-[#12080d]/80 p-5 shadow-[0_0_70px_rgba(244,63,94,.22)] backdrop-blur-xl">
          <div className="mb-5 flex items-center justify-between">
            <button
              ...
              className="rounded-full border border-[#f7d7a2]/15 px-3 py-2 text-xs text-[#f7d7a2]"
            >
              ← Top
            </button>
            <div className="text-center">
          ...
          <div className="grid gap-4">
            <Panel title="部屋名">
              <input
                ...
                className="input"
                placeholder="例：二次会、同窓会"
              />
            </Panel>

            <Panel title="テーブル配置">
              <div className="grid grid-cols-2 gap-2">
                <Choice active={tableShape === "round"} onClick={() => setTableShape("round")}>
                  ○ 円卓
                </Choice>
                <Choice active={tableShape === "rectangle"} onClick={() => setTableShape("rectangle")}>
                  ▭ 長方形
                </Choice>
              </div>
            </Panel>
            ...
            <Panel title="席数">
              <select value={seatCount} onChange={(e) => changeSeatCount(e.target.value)} className="input">
                {[4, 5, 6, 7, 8, 10, 12, 14, 16, 20].map((n) => (
            ...
            <Panel title="作成者の席を登録">
              ...
              <div className="mt-3 grid grid-cols-2 gap-2">
                <Choice active={creatorGender === "女性"} onClick={() => setCreatorGender("女性")}>
                  ♀ 女性
                </Choice>
                <Choice active={creatorGender === "男性"} onClick={() => setCreatorGender("男性")}>
                  ♂ 男性
                </Choice>
              </div>
            </Panel>
            ...
            <Panel title="投票設定">
              <p className="mb-3 text-xs leading-5 text-[#e6c9aa]/65">
                投票対象と人数を最初に決めます。イベント中に迷わせたくない場合は「異性のみ」がおすすめです。
              </p>
              <div className="mb-3 grid grid-cols-2 gap-2">
                <Choice active={targetMode === "opposite"} onClick={() => setTargetMode("opposite")}>
                  💘 異性のみ
                </Choice>
                <Choice active={targetMode === "all"} onClick={() => setTargetMode("all")}>
                  👥 全員
                </Choice>
              </div>

              <p className="mb-3 text-xs leading-5 text-[#e6c9aa]/65">
                基本は1人だけ選びますが、複数人選択もOKにできます。
              </p>
            ...
            <button
              ...
              className="rounded-2xl bg-gradient-to-r from-rose-500 via-pink-500 to-[#f7d7a2] px-5 py-4 text-sm font-black text-white disabled:opacity-40"
            >
              ♡ 自分の席を登録して部屋URLを作成
            </button>
          </div>
    ...
    return (
      <div className="mb-4 rounded-[2rem] border border-[#f7d7a2]/20 bg-black/35 p-3 backdrop-blur-xl">
        <div className="flex items-center justify-between gap-3">
          <button type="button" onClick={() => setMode("home")} className="smallBtn">
            ← Top
          </button>
          <div className="text-center">
          ...
          <button type="button" onClick={resetAll} className="smallBtn">
            Reset
          </button>
        </div>
        <div className="mt-3 rounded-2xl border border-[#f7d7a2]/15 bg-[#12080d]/80 px-3 py-2 text-xs text-[#f5dcae]/80">
          {roomUrl}
        </div>
        <div className="mt-3 flex items-center justify-between gap-2">
          <PhaseBadge />
          <span className="text-xs text-[#e6c9aa]/65">
            第{roundNumber}回・参加 {filledSeats}/{seatCount}・投票 {votedCount}/{filledSeats}
          </span>
        </div>
      </div>
    );
    ...
    return (
      <section className="screen">
        <Title
          over="ENTRY"
          title="席と名前を入力"
          text="入力は結果公表前まで修正できます。幹事が投票タイムを開始します。"
        />
          ...
          {phase === "result" ? (
            ...
            <div className="text-center">
              ...
              <button
                ...
                className="mt-4 w-full rounded-2xl border border-rose-300/35 bg-rose-500/15 px-4 py-3 text-sm font-black text-rose-100"
              >
                間違えて登録したので削除する
              </button>
            </div>
            ...
            <div>
              <p className="mb-3 text-center text-sm font-bold text-[#f7d7a2]">
                {selectedSeat.label}番席で参加
              </p>
              <input
                value={draftName}
              ...
              />
              <div className="mt-3 grid grid-cols-2 gap-2">
                <Choice active={draftGender === "女性"} onClick={() => setDraftGender("女性")}>
                  ♀ 女性
                </Choice>
                <Choice active={draftGender === "男性"} onClick={() => setDraftGender("男性")}>
                  ♂ 男性
                </Choice>
              </div>
              <button type="button" onClick={registerSeat} disabled={!draftName.trim()} className="mainBtn mt-3">
                ♡ この席で参加する
              </button>
            </div>
          )}
        ...
        <Panel title="進行操作">
          <label className="mb-3 flex items-center justify-between gap-3 rounded-2xl border border-[#f7d7a2]/15 bg-black/25 px-4 py-3 text-sm font-bold text-[#ffe8b7]">
            ...
            <input
              type="checkbox"
              checked={progressUnlocked}
              onChange={(e) => setProgressUnlocked(e.target.checked)}
          ...
          <button
            type="button"
            onClick={startVoting}
            disabled={filledSeats < 2 || phase === "result" || !progressUnlocked}
            className="goldBtn"
          >
            投票タイム開始
          </button>
          <p className="mt-2 text-center text-xs text-[#e6c9aa]/60">
            空席はOK。結果公表前なら席の追加・削除・修正ができます。進行ボタンはロック解除時だけ押せます。
          </p>
        </Panel>
      </section>
    );
    ...
    return (
      <section className="screen">
        <Title
          over="IDENTITY CHECK"
          title="本人確認"
          text="投票は本人だけができます。自分の名前を選んで確認してください。"
        />

        {phase !== "voting" ? (
          <Panel>
            <p className="text-center text-sm text-[#e6c9aa]/70">現在は投票タイムではありません。</p>
          </Panel>
        ) : (
          <>
            <div className="grid gap-3">
              {members.map((m) => {
                ...
                return (
                  <button
                    type="button"
                    key={m.id}
                    onClick={() => setPendingVoterId(m.id)}
                    className={`personCard ${
                      active ? "border-rose-300 bg-rose-500/25" : "border-[#f7d7a2]/15 bg-black/25"
                    }`}
                  >
                    <Avatar member={m} />
                    <div className="min-w-0 flex-1">
                      <p className="font-black text-white">
                        {m.seatId.replace("seat-", "")}番 {m.name}
                      </p>
                      <p className="text-xs text-[#e6c9aa]/65">
                        {m.gender}・{done ? "投票済み" : "未投票"}
                      </p>
                    </div>
                  </button>
                );
            ...
            <Panel>
              {pendingVoter ? (
                <div className="text-center">
                  ...
                  <button type="button" onClick={confirmVoter} className="mainBtn mt-4">
                    はい、本人です。投票する
                  </button>
                </div>
              ) : (
            ...
            <button type="button" onClick={publishResults} disabled={!canPublish} className="outlineBtn mt-4">
              幹事が結果公表タイムへ進める
            </button>
            {!canPublish && (
              <p className="mt-2 text-center text-xs text-[#e6c9aa]/60">
                登録済み全員が投票済み、かつ誤操作防止ロック解除中に公表できます。
              </p>
            )}
          </>
        )}
  ...
  function VoteScreen() {
    if (!currentMember || phase !== "voting") {
      return (
        <section className="screen">
          <Panel>
            <p className="text-center text-sm text-[#e6c9aa]/70">本人確認から投票してください。</p>
          </Panel>
        </section>
      );
    }
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="font-serif text-4xl font-black text-white">
                {currentMember.seatId.replace("seat-", "")}番
              </p>
          ...
          {candidates.map((c) => {
            ...
            return (
              <button
                ...
                className={`personCard ${
                  selected ? "border-rose-300 bg-rose-500/25" : "border-[#f7d7a2]/15 bg-black/25"
                }`}
              >
                <Avatar member={c} />
                <div className="min-w-0 flex-1">
                  <p className="font-black text-white">
                    {c.seatId.replace("seat-", "")}番 {c.name}
                  </p>
                ...
                <div
                  className={`flex h-11 w-11 items-center justify-center rounded-full border text-xl ${
                    selected ? "border-rose-200 bg-rose-500 text-white" : "border-white/20 text-white/55"
                  }`}
                >
                  ♡
                </div>
  ...
  function ResultScreen() {
    return (
      <section className="screen">
        <Title
          over="PUBLIC RESULT"
          title={`第${roundNumber}回 両想い発表`}
          text="成立したペアだけ一括公表します。"
        />

        {phase !== "result" ? (
          <Panel>
            <p className="text-center text-xl font-black text-[#ffe8b7]">まだ結果公表前です</p>
            <button type="button" onClick={publishResults} disabled={!canPublish} className="goldBtn mt-4">
              結果公表タイムにする
            </button>
            <p className="mt-2 text-center text-xs text-[#e6c9aa]/60">
              登録済み全員が投票済み、かつ誤操作防止ロック解除中に公表できます。
          ...
          <div className="grid gap-4">
            {mutualPairs.map(([a, b]) => (
              <div
                key={`${a.id}-${b.id}`}
                className="rounded-[2rem] border border-rose-300/30 bg-gradient-to-br from-rose-500/15 to-pink-500/10 p-5 shadow-[0_0_30px_rgba(244,63,94,.15)]"
              >
                ...
                <p className="text-center font-serif text-2xl font-black text-white">
                  {a.name}さん と {b.name}さん
                </p>
          ...
          <Panel>
            <div className="py-4 text-center">
              ...
              <p className="mt-3 text-xl font-black text-[#ffe8b7]">今回は両想い成立なし</p>
              <p className="mt-2 text-sm text-[#e6c9aa]/65">
                次のラウンドでチャンスがあるかも...！
              </p>
            </div>
          </Panel>
        ...
        <Panel title="オプション：自分に届いた矢印を見る">
          ...
          {showIncoming && (
            <div className="mt-4 grid gap-3">
              ...
              {currentMember && (
                <p className="rounded-2xl bg-white/[0.04] p-4 text-sm text-[#e6c9aa]/75">
                  {currentMember.name}さんに届いた矢印：{incomingVotes.length}人
                </p>
              )}
            </div>
          )}
        ...
        {/* 次のラウンドパネル */}
        {phase === "result" && (
          <Panel title="次の投票ラウンド">
            <p className="mb-3 text-xs text-[#e6c9aa]/65">
              メンバーそのままで、もう一度投票できます。第{roundNumber + 1}回の投票を始めましょう。
            </p>
            <label className="mb-3 flex items-center justify-between gap-3 rounded-2xl border border-[#f7d7a2]/15 bg-black/25 px-4 py-3 text-sm font-bold text-[#ffe8b7]">
              <span>誤操作防止ロックを解除</span>
              <input
        ...
        <Panel title="部屋の管理">
          ...
          <button
            ...
            disabled={!progressUnlocked}
            className="w-full rounded-2xl border border-red-400/40 bg-red-500/20 px-4 py-3 text-sm font-black text-red-200 disabled:opacity-40"
          >
            この部屋を削除する
          </button>
          <p className="mt-2 text-center text-xs text-[#e6c9aa]/50">
            メンバーと投票データもすべて削除されます。この操作は取り消せません。
          </p>
        </Panel>
      </section>
