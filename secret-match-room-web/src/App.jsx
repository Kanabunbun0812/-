          ...
          <div className="grid gap-4">
            ...
            <Panel title="投票設定">
              <p className="mb-3 text-xs leading-5 text-[#e6c9aa]/65">
                投票対象を最初に決めます。イベント中に迷わせたくない場合は「異性のみ」がおすすめです。
              </p>
      ...
      <div className="mb-4 rounded-[2rem] border border-[#f7d7a2]/20 bg-black/35 p-3 backdrop-blur-xl">
        ...
        <div className="mt-3 flex items-center justify-between gap-2">
          ...
          <span className="text-xs text-[#e6c9aa]/65">
            参加 {filledSeats}/{seatCount}・投票 {votedCount}/{filledSeats}
          </span>
        </div>
      </div>
    );
      ...
      <section className="screen">
        ...
        <Panel title="投票対象">
          <p className="text-sm text-[#e6c9aa]/75">
            この部屋は {targetMode === "opposite" ? "異性のみ" : "全員"} に投票できます。
          </p>
        </Panel>
    ...
    return (
      <section className="screen">
        ...
        {phase !== "result" ? (
          ...
          <Panel>
            <p className="text-center text-xl font-black text-[#ffe8b7]">今回は両想いなし</p>
          </Panel>
        )}
